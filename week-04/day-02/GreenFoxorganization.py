...
class Student(Person):
    ...
    def introduce(self):
        print("Hi, I'm {}, a {} year old {} from {} who skipped {} days from the course already.".format(self.name,
         self.age, self.gender, self.previous_organization, self.skipped_days))
...
class Sponsor(Person):
    ...
    def introduce(self):
        print("Hi, I'm {}, a {} year old {} who represents {} and hired {} students so far.".format(self.name,
         self.age, self.gender, self.company, self.hired_students))
...
class PallidaClass(object): 
    ...
    def info(self):
        print("Pallida {} class has {} students and {} mentors.".format(self.class_name,
         len(self.students), len(self.mentors)))
