...
def fractal_carpet(x,y,width):
    if width < 2:
        ...
        return fractal_carpet(start_x,y,width/3), fractal_carpet(x,start_y,width/3), fractal_carpet(start_x+width,start_y,width/3), fractal_carpet(start_x,start_y+width,width/3)
fractal_carpet(0,0,width)
